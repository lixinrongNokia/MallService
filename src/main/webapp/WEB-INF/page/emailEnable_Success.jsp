...
<TABLE cellSpacing=15 cellPadding=0 width="100%" border=0>
    ...
    <TR>
        <TD vAlign=bottom>
            <NOBR><A class=ablue2 href="#">返回</A></NOBR>
            <SPAN class=important> &gt; </SPAN>
            <NOBR class=font-title>激活邮箱</NOBR>
        </TD>
    </TR>
    </TBODY>
</TABLE>
                        ...
                        <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center
                            ...
                            <TR>
                                ...
                                <TD vAlign=bottom noWrap width="20%" bgColor=#ddddcc
                                    height=28><SPAN class=title>激活邮箱&nbsp;&nbsp;</SPAN></TD>
