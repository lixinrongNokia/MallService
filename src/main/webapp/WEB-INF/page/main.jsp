...
<HEAD>
    ...
    <SCRIPT language=JavaScript>
        ...
        //某月的第几个星期几
        var wFtv = ["0131 Martin Luther King Day",
        ...
        <TABLE>
            ...
            <TR>
                <TD vAlign=top align=middle><BR><FONT style="FONT-SIZE: 9pt"
                                                      size=2>本地时间:</FONT><BR><FONT id=Clock face=Arial color=#000080
                                                                                   size=4
                                                                                   align="center"></FONT>
                    <P><!--时区 *表示自动调整为日光节约时间--><FONT style="FONT-SIZE: 9pt" size=2>
                        <SELECT
                            ...
                            id=CITY
                            style="FONT-SIZE: 9pt; WIDTH: 150px; COLOR: blue; FONT-FAMILY: '宋体'"></FONT></P>
                </TD>
                <TD align=middle>
                ...
                <TD vAlign=top align=middle width=60><BR><BR><BR><BR>
                    ...
                    <P>
                        <BUTTON style="FONT-SIZE: 9pt"
                                onclick="pushBtm('MU')">月↑
                        </BUTTON>
                        <BR>
                        <BUTTON style="FONT-SIZE: 9pt"
                                onclick="pushBtm('MD')">月↓
                        </BUTTON>
                    <P>
