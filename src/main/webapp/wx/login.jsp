...
<div id="main" class="box-ver box">
    ...
    <div id="header">
        <header>
            <h1>登 录</h1>
            <div class="back" onclick="window.location.href='onLineMall.do'">返回
            </div>
            <div class="headerRight" onclick="openwin('reg');">注册</div>
        </header>
    </div>
    <!--header结束 -->
    <!--content开始-->
...
<script>
    jQuery(function () {
        jQuery("#content").load("${pageContext.request.contextPath }/wx/login_content.jsp");
    });
    history.go(1);
</script>
