package cn.iliker.mall.utils.wxpay.client;

import cn.iliker.mall.utils.wxpay.HttpClientUtil;
...
public class TenpayHttpClient {
    ...
    /*微信退款请求*/
    public void callHttpPostSSL(String url, String data) throws Exception {
        KeyStore keyStore = KeyStore.getInstance("PKCS12");
        try (FileInputStream instream = new FileInputStream(new File("D:/10016225.p12"))) {
