...
<TABLE style="cellSpacing:15; cellPadding:0; width:100%; border:0;align-content: center">
    <TBODY>
    <TR>
                                                ...
                                                <TABLE cellSpacing=4 cellPadding=4 width="100%" border=0>
                                                    ...
                                                    <TR align=left>
                                                        <TD><SPAN class=font-step>第二步：</SPAN><SPAN
                                                                class=font14b>请查看您帐户设定的电子邮件信箱</SPAN></TD>
                                                    </TR>
                                                    <TR align=left>
                                                        <TD class=font9>
                                                            <P>为了验证您的身份，我们已发出了通知信，请在24小时内点击邮件内的链接继续设置新密码。</P></TD>
                                                    </TR>
                                                    <TR align=left>
                                                        <TD>
                                                    ...
                                                    <TR align=left>
                                                        <TD class=font9>
                                                            <P class=font9> 如果您忘记密码且不再使用注册时的E-mail，建议向管理员申请新账号。</P></TD>
                                                    </TR>
                                                    </TBODY>
                                                </TABLE>
                                                <!--  content  -->
